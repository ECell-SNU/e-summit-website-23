      ...
      <div className="grid w-full gap-3 sm:gap-6 xl:grid-cols-[40%_27%_30%]">
        <div className="col-span-1 flex h-fit flex-col items-center gap-2 rounded-2xl bg-[#111111] p-4 sm:p-8">
          ...
          <p className="text-sm sm:text-lg lg:text-xl">
            ...
            ideathon. Four amazing themes to choose from, form a group of upto 4
            people and make the best B-Plan you can. Head over to Unstop to
            learn more about this event. 24 hours. Only the best minds. 3 lakhs
            at stake. Grab your piece of the pie.
          </p>
          <div className="m-2 flex w-full flex-col justify-between gap-5 sm:m-6 md:flex-row md:gap-10 md:px-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="https://drive.google.com/file/d/1wXY4JnB3D5CicZwD-k8XnNJAqJAAipzl/view?usp=share_link"
        ...
        >
          {details.map((detail, index) => (
            <div className="flex flex-col gap-1" key={index}>
              ...
              <p className="sm:text-md text-sm lg:text-lg">{detail.content}</p>
            </div>
          ))}
        </div>
